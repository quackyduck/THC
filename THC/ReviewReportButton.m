...
#import "ReviewReportButton.h"

@implementation ReviewReportButton
...
- (void)drawRect:(CGRect)rect
{
    ...
    //// Group
    {
        ...
        //// Group 2
        {
            ...
            CGRect newReportTextRect = CGRectMake(68.5f, 13.06f, 200, 22.38f);
            {
                NSString* textContent = @"Review Report Details";
            ...
            //// image Drawing
            UIBezierPath* imagePath = [UIBezierPath bezierPathWithRect: CGRectMake(41, 10.75, 22, 27)];
            CGContextSaveGState(context);
            [imagePath addClip];
            CGContextScaleCTM(context, 1.0, -1.0);
            CGContextDrawTiledImage(context, CGRectMake(41, 17, btn_create_normal.size.width, btn_create_normal.size.height), btn_create_normal.CGImage);
            CGContextRestoreGState(context);
        }
